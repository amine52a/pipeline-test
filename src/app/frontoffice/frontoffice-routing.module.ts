...
import { MlMatchingComponent } from './ml-matching/ml-matching.component';
import { MlPrixComponent } from './ml-prix/ml-prix.component';
import { MlProfilComponent } from './ml-profil/ml-profil.component';
import { MlFeasibilityComponent } from './ml-feasibility/ml-feasibility.component';
...
const routes: Routes = [
  ...
  { path: 'alt-home', component: AltHomeComponent },
  {
    ...
    children: [
      // ML Testing Routes - Place BEFORE empty path
      { path: 'ml-matching', component: MlMatchingComponent },
      { path: 'ml-prix', component: MlPrixComponent },
      { path: 'ml-profil', component: MlProfilComponent },
      { path: 'ml-feasibility', component: MlFeasibilityComponent },
