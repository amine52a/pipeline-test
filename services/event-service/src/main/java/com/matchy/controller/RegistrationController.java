...
import com.matchy.security.AuthContext;
...
public class RegistrationController {
    ...
    public ResponseEntity<RegistrationDTO> createRegistration(
        ...
        // Override whatever userId the client sent with the authenticated subject from the JWT.
        Long jwtUserId = AuthContext.currentUserId(request);
        if (jwtUserId != null) {
            createDTO.setUserId(jwtUserId);
        }
